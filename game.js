...
var ASM_CONSTS = {
 ...
 94390: () => { return Module.canvas.width; },  
 94422: () => { return parseInt(Module.canvas.style.width); },  
 94470: () => { document.exitFullscreen(); },  
 94497: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 94570: () => { if (document.fullscreenElement) return 1; },  
 94616: () => { return Module.canvas.width; },  
 94648: () => { return screen.width; },  
 94673: () => { document.exitFullscreen(); },  
 94700: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 94833: () => { return window.innerWidth; },  
 94859: () => { return window.innerHeight; },  
 94886: () => { if (document.fullscreenElement) return 1; },  
 94932: () => { return Module.canvas.width; },  
 94964: () => { return parseInt(Module.canvas.style.width); },  
 95012: () => { if (document.fullscreenElement) return 1; },  
 95058: () => { return Module.canvas.width; },  
 95090: () => { return screen.width; },  
 95115: () => { return window.innerWidth; },  
 95141: () => { return window.innerHeight; },  
 95168: () => { if (document.fullscreenElement) return 1; },  
 95214: () => { return Module.canvas.width; },  
 95246: () => { return screen.width; },  
 95271: () => { document.exitFullscreen(); },  
 95298: () => { if (document.fullscreenElement) return 1; },  
 95344: () => { return Module.canvas.width; },  
 95376: () => { return parseInt(Module.canvas.style.width); },  
 95424: () => { document.exitFullscreen(); },  
 95451: ($0) => { Module.canvas.style.opacity = $0; },  
 95489: () => { return screen.width; },  
 95514: () => { return screen.height; },  
 95540: () => { return window.screenX; },  
 95567: () => { return window.screenY; },  
 95594: () => { return window.devicePixelRatio; },  
 95630: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 95683: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 95734: () => { Module.canvas.style.cursor = 'none'; },  
 95771: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 96027: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 96078: () => { if (document.fullscreenElement) return 1; },  
 96124: () => { return window.innerWidth; },  
 96150: () => { return window.innerHeight; },  
 96177: () => { if (document.pointerLockElement) return 1; }
};
